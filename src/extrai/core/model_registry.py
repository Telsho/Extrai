...
class ModelRegistry:
    ...
    def __init__(self, root_model: Type[SQLModel], logger: Optional[logging.Logger] = None):
        """
    ...
    def _generate_llm_schema(self) -> str:
        ...
        try:
            ...
            raise ConfigurationError(
                f"Failed to generate LLM schema: {e}"
            ) from e
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"ModelRegistry(root={self.root_model.__name__}, "
