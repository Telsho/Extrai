...
from extrai.core.result_processor import ResultProcessor, DirectHydrator, SQLAlchemyHydrator
...
class TestResultProcessorStrategies(unittest.TestCase):
    def setUp(self):
        ...
        self.processor = ResultProcessor(self.model_registry, unittest.mock.Mock(), self.logger)
    ...
    def test_auto_detect_sqlalchemy_hydrator(self):
        ...
        with unittest.mock.patch("extrai.core.result_processor.SQLAlchemyHydrator") as MockSQLHydrator:
    ...
    def test_auto_detect_direct_hydrator_no_temp_id(self):
        ...
        with unittest.mock.patch("extrai.core.result_processor.DirectHydrator") as MockDirectHydrator:
    ...
    def test_direct_hydrator_default_model(self):
        ...
        results = hydrator.hydrate(data, self.model_registry.model_map, default_model_class=StrategyAuthor)
