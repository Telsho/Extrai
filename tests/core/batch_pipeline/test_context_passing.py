...
class TestBatchPipelineContext(unittest.IsolatedAsyncioTestCase):
    def setUp(self):
        ...
        self.mock_client.create_batch_job = AsyncMock(
        ...
        self.patchers = {
            ...
            "ExtractionContextPreparer": patch(
            ...
            "ConsensusRunner": patch(
                "extrai.core.batch.batch_pipeline.ConsensusRunner"
            ),
            "ExtractionRequestFactory": patch(
                "extrai.core.batch.batch_pipeline.ExtractionRequestFactory"
            ),
        }
    ...
    async def test_submit_counting_phase_passes_context(self):
        ...
        await self.pipeline.submitter._submit_counting_phase(
            context, mock_session, step_index=1
        )
    ...
    async def test_submit_extraction_phase_passes_context(self):
        ...
        await self.pipeline.submitter._submit_extraction_phase(
            context, mock_session, step_index=1
        )
