...
class TestBatchPipelineStructured(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_retrieve_and_validate_results_missing_type(self):
        ...
        mock_client.retrieve_batch_results = AsyncMock(return_value=json.dumps(structured_response))
        ...
        mock_client.extract_content_from_batch_response.return_value = json.dumps(structured_response)
